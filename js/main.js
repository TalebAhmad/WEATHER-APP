...
// GET THE CONDITIONS
//weatherConditions.open('GET', 'http://api.wunderground.com/api/112919b37609d3de/conditions/q/E3B4C3.json', true);
//weatherConditions.responseType = 'text';
//weatherConditions.send(null);
...
// GET THE FORECARST
//weatherForecast.open('GET', 'http://api.wunderground.com/api/112919b37609d3de/forecast/q/E3B4C3.json', true);
//weatherForecast.responseType = 'text'; 
//weatherForecast.send();
